...
Package website can be found at <https://darwin-eu.github.io/CodelistGenerator/>
...
2.  Do you identify any more codes if you also search in the observation domain
...
```{r}
tableCodeUse(asthma_code_use |> 
               filter(strata_name == "age group and sex"))
```
...
1.  Identify codes for concussion

2.  Get a count of the usage of these codes

3.  Search for orphan concepts related to your concussion codes
